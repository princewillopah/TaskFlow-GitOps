...
backend_image="princewillopah2/color-manager-app_backend"
frontend_image="princewillopah2/color-manager-app_frontend"
image_tag="1.1.5"
current_dir=$(pwd)
...
#   -d '{"name": "color-manager-app/backend", "description": "My repo"}'
...
echo " ================================================================= "
docker build -t $backend_image:$image_tag $current_dir/apps/backend
...
echo " ================================================================= "
docker build -t $frontend_image:$image_tag $current_dir/apps/frontend
